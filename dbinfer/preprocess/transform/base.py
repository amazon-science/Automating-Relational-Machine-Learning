...
class RDBData:
    ...
    val_timestamp_cutoff : Optional[str] = None
    test_timestamp_cutoff : Optional[str] = None
    time_column_name : Optional[Dict[str, str]] = None
...
class RDBTransform:
    ...
    def fit_transform(
        ...
        return self.transform(rdb_data, device, metadata)
